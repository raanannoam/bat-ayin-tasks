...
var BatAyinAdapters = (() => {
  ...
  var NOT_IMPLEMENTED2 = "Not implemented yet";
  function throwNotImplemented2() {
    throw new Error(NOT_IMPLEMENTED2);
  }
  ...
  var NOT_IMPLEMENTED3 = "Not implemented yet";
  function throwNotImplemented3() {
    throw new Error(NOT_IMPLEMENTED3);
  }
  function createSupabaseSuppliersAdapter() {
    return {
      loadSuppliers() {
        return throwNotImplemented3();
      },
      saveSuppliers() {
        return throwNotImplemented3();
      },
